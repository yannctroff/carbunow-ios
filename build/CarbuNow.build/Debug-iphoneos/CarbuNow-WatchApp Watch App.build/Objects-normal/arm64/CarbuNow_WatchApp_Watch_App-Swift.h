...
#ifndef CARBUNOW_WATCHAPP_WATCH_APP_SWIFT_H
#define CARBUNOW_WATCHAPP_WATCH_APP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CarbuNow_WatchApp_Watch_App",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC27CarbuNow_WatchApp_Watch_App23WatchConnectivityBridge")
@interface WatchConnectivityBridge : NSObject
...
@class WCSession;
@class NSString;
@interface WatchConnectivityBridge (SWIFT_EXTENSION(CarbuNow_WatchApp_Watch_App)) <WCSessionDelegate>
...
@class CLLocation;
SWIFT_CLASS("_TtC27CarbuNow_WatchApp_Watch_App20WatchLocationManager")
@interface WatchLocationManager : NSObject <CLLocationManagerDelegate>
